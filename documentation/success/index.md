...
<div style="margin-top: 20px;">
	<div class="row">
		...
		<div class="col-md-8 col-sm-8 col-xs-12">
			...
			the data analysts used VerdictDB on top of their existing data analytics
			engines without making any modifications.
			VerdictDB could successfully reduce the latencies of their large-scale analytical queries
			down to a few seconds.
			Check Walmart's short presentation about 
...
<div style="margin-top: 20px;">
	<div class="row">
		...
		<div class="col-md-8 col-sm-8 col-xs-12">
			 ...
			 mobile activities.
			 In building such a web platform, the essential part was achieving real-time responses
			 ...
			 To solve this problem, LOCALLY started to use VerdictDB, which could compute
